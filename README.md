...
create a `.env` file at root and include `MONGO_URL=mongodb+srv://rohitpatekar936:Rohit1215@cluster0.yldq7rh.mongodb.net/?retryWrites=true&w=majority` this in it
